...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::scheduler_cmd::scheduler_fairness_group_count,
            commands::scheduler_cmd::scheduler_fairness_workspace_count,
            commands::scheduler_cmd::scheduler_fairness_reset,
            commands::scheduler_cmd::scheduler_budget_reset,
            commands::scheduler_cmd::scheduler_budget_clear_breach,
            commands::scheduler_cmd::scheduler_concurrency_is_running,
            commands::scheduler_cmd::scheduler_concurrency_get_kind,
            commands::scheduler_cmd::scheduler_concurrency_reset,
            commands::scheduler_cmd::scheduler_metrics_reset,
            commands::scheduler_cmd::scheduler_rate_limiter_reset,
            commands::scheduler_cmd::scheduler_retry_len,
            commands::scheduler_cmd::scheduler_retry_clear,
            commands::scheduler_cmd::scheduler_dead_queue_contains,
            commands::scheduler_cmd::scheduler_budget_get_reservation,
            commands::scheduler_cmd::scheduler_concurrency_running_count_direct,
            commands::scheduler_cmd::scheduler_concurrency_get_kind_count,
            commands::scheduler_cmd::scheduler_retry_is_eligible,
            commands::scheduler_cmd::scheduler_retry_get_all,
            commands::scheduler_cmd::scheduler_queue_peek,
            commands::scheduler_cmd::scheduler_queue_is_empty,
            commands::scheduler_cmd::scheduler_queue_contains,
            commands::scheduler_cmd::scheduler_queue_size,
            commands::scheduler_cmd::scheduler_queue_clear,
            ...
            commands::workflow_cmd::workflow_recover_run,
            commands::workflow_cmd::workflow_check_execution_status,
            commands::workflow_cmd::workflow_get_node_incoming_edges,
            commands::workflow_cmd::workflow_get_snapshot_id,
            // Event Log
