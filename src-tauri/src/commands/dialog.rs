...
#[tauri::command]
pub fn dialog_open_file_via_manager(app: AppHandle, filter: Option<String>) -> Result<Option<String>, String> {
...
#[tauri::command]
pub fn dialog_save_file_via_manager(app: AppHandle, default_name: String) -> Result<Option<String>, String> {
    let mgr = app.state::<DialogManagerImpl>();
