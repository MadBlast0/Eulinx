...
const colorPrimitives: PrimitiveToken[] = [
  ...
  ...RAMP_STEPS.map((s) => rampPrimitive("coral", s, CORAL[s], coralUsage)),
...
const radiusPrimitives: PrimitiveToken[] = Object.entries(radiusValues).map(([variant, val]) => ({
  ...
  value: val,
  themeScope: "invariant" as const,
  usage: `Corner radius "${variant}". Default md (14px) for cards/buttons, lg (20px) for dialogs, full for pills.`,
}));
...
const componentTokens: ComponentToken[] = [
  ...
  },
  {
    layer: "component",
    category: "color",
    name: "--Eulinx-color-node-input",
    binding: "--Eulinx-color-node-input",
    owner: "NodeGraph",
    usage: "Accent for input/entry-point nodes.",
  },
  {
    layer: "component",
    category: "color",
    name: "--Eulinx-color-node-output",
    binding: "--Eulinx-color-node-output",
    owner: "NodeGraph",
    usage: "Accent for output/terminal-result nodes.",
  },
  {
    layer: "component",
    category: "color",
    name: "--Eulinx-color-node-orchestrator",
    binding: "--Eulinx-color-node-orchestrator",
    owner: "NodeGraph",
    usage: "Accent for orchestrator nodes.",
  },
  {
    layer: "component",
    category: "color",
    name: "--Eulinx-color-node-builder",
    binding: "--Eulinx-color-node-builder",
    owner: "NodeGraph",
    usage: "Accent for builder nodes.",
  },
  {
    layer: "component",
    category: "color",
    name: "--Eulinx-color-node-verifier",
    binding: "--Eulinx-color-node-verifier",
    owner: "NodeGraph",
    usage: "Accent for verifier nodes.",
  },
  {
    layer: "component",
    category: "color",
    name: "--Eulinx-color-node-condition",
    binding: "--Eulinx-color-node-condition",
    owner: "NodeGraph",
    usage: "Accent for condition/branch nodes.",
  },
  {
    layer: "component",
    category: "color",
    name: "--Eulinx-color-node-loop",
    binding: "--Eulinx-color-node-loop",
    owner: "NodeGraph",
    usage: "Accent for loop/iteration nodes.",
  },
  {
    layer: "component",
    category: "color",
    name: "--Eulinx-color-node-artifact",
    binding: "--Eulinx-color-node-artifact",
    owner: "NodeGraph",
    usage: "Accent for artifact/output-file nodes.",
  },
  {
    layer: "component",
    category: "color",
    name: "--Eulinx-color-node-mcp",
    binding: "--Eulinx-color-node-mcp",
    owner: "NodeGraph",
    usage: "Accent for MCP integration nodes.",
  },
  {
    layer: "component",
    category: "color",
    name: "--Eulinx-color-node-delay",
    binding: "--Eulinx-color-node-delay",
    owner: "NodeGraph",
    usage: "Accent for delay/wait nodes.",
  },
  {
    layer: "component",
    category: "color",
    name: "--Eulinx-color-node-human",
    binding: "--Eulinx-color-node-human",
    owner: "NodeGraph",
    usage: "Accent for human-in-the-loop nodes.",
  },
  {
    layer: "component",
    category: "color",
    name: "--Eulinx-color-node-switch",
    binding: "--Eulinx-color-node-switch",
    owner: "NodeGraph",
    usage: "Accent for switch/routing nodes.",
  },
  {
    layer: "component",
    category: "color",
    name: "--Eulinx-color-node-filter",
    binding: "--Eulinx-color-node-filter",
    owner: "NodeGraph",
    usage: "Accent for filter nodes.",
  },
  {
    layer: "component",
    category: "color",
    name: "--Eulinx-color-node-set",
    binding: "--Eulinx-color-node-set",
    owner: "NodeGraph",
    usage: "Accent for set/variable nodes.",
  },
  {
    layer: "component",
    category: "color",
    name: "--Eulinx-color-node-code",
    binding: "--Eulinx-color-node-code",
    owner: "NodeGraph",
    usage: "Accent for code nodes.",
  },
];
