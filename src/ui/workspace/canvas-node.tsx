...
const NODE_TOKEN: Record<NodeKind, string> = {
  ...
  input:          "var(--Eulinx-color-node-input)",
  output:         "var(--Eulinx-color-node-output)",
  worker:         "var(--Eulinx-color-node-worker)",
  orchestrator:   "var(--Eulinx-color-node-orchestrator)",
  builder:        "var(--Eulinx-color-node-builder)",
  verifier:       "var(--Eulinx-color-node-verifier)",
  condition:      "var(--Eulinx-color-node-condition)",
  loop:           "var(--Eulinx-color-node-loop)",
  merge:          "var(--Eulinx-color-node-terminal)",
  artifact:       "var(--Eulinx-color-node-artifact)",
  memory:         "var(--Eulinx-color-node-map)",
  tool:           "var(--Eulinx-color-node-terminal)",
  mcp:            "var(--Eulinx-color-node-mcp)",
  delay:          "var(--Eulinx-color-node-delay)",
  human_approval: "var(--Eulinx-color-node-human)",
  // ── n8n-inspired kinds ──
  switch:          "var(--Eulinx-color-node-switch)",
  filter:          "var(--Eulinx-color-node-filter)",
  set:             "var(--Eulinx-color-node-set)",
  code:            "var(--Eulinx-color-node-code)",
  threshold:       "var(--Eulinx-color-node-condition)",
  webhook_trigger: "var(--Eulinx-color-node-input)",
  schedule_trigger:"var(--Eulinx-color-node-input)",
  http_request:    "var(--Eulinx-color-node-mcp)",
